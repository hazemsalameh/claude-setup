...
time.sleep(1)
SIGNATURE = "\n\n— 🤖 *sent by Claude on Hazem's behalf*"
chrome('insert_text', selector='[data-slate-editor="true"]', text='MESSAGE HERE' + SIGNATURE)
time.sleep(1)
...
Always append the following signature to every message:
```
\n\n— 🤖 *sent by Claude on Hazem's behalf*
```
